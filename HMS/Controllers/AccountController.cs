...
namespace HMS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Staff()
        {
            ...
            var Members = new List<StaffView>();
            if (db.Users != null)
            {
                foreach (var user in db.Users.Where(x=>x.UserType.Equals("MedicalStaff")))
                {
                   
                    StaffView staff = new StaffView();
                    staff.fname = user.FirstName;
                    staff.lname = user.LastName;
                    staff.image = user.UserPhoto;
                    Members.Add(staff);
                }
