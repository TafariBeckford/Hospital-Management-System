...
{ 
    ...
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,FirstName,LastName,Gender,Address,Town,Parish,DOB,Position")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,FirstName,LastName,Gender,Address,Town,Parish,DOB")] Employee employee)
        {
            if (ModelState.IsValid)
            {
